...
export const cyclePhaseDetailsMap = new Map<CyclePhaseEnum, CyclePhaseDetails>([
    [CyclePhaseEnum.MENSTRUAL, {
        ...
        feelings: { level: 1, explanation: "Might feel sad or experience PMS symptoms" },
    ...
    [CyclePhaseEnum.FOLLICULAR, {
        ...
        feelings: { level: 2, explanation: "Generally feel better and more energetic" },
    ...
    [CyclePhaseEnum.LUTEAL, {
        ...
        feelings: { level: 2, explanation: "Mood swings are possible, PMS symptoms may start" },
